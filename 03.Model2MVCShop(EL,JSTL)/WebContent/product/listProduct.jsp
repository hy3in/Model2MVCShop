...
<table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-top:10px;">
	<tr>
		...
		<td colspan="3" ><a href="/listProduct.do?menu=search&sort=1"/>높은가격순
		<a href="/listProduct.do?menu=search&sort=2"/>낮은가격순</td>
	</tr>
	<tr>
	...
	<tr>
		...
		<c:forEach var="product" items="${list}">
			...
			<c:if test = "${menuType eq 'manage'}">
				<a href="/updateProductView.do?prodNo=${product.prodNo}" ></a>
			</c:if>
