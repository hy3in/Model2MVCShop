...
$(function(){
	$("td.ct_write01 img").on('click',function(){
		var date = show_calendar('document.addPurchase.receiverDate',$("input[name='receiverDate']").val());
		$("input[name='receiverDate']").val(date);
		});
})
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<input type="hidden" name="buyerId" value="user05" />
	</tr>
	<tr>
		<td height="1" colspan="3" bgcolor="D6D6D6"></td>
	</tr>
